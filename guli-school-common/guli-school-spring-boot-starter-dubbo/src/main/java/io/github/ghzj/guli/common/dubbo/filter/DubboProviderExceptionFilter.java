package io.github.ghzj.guli.common.dubbo.filter;

import io.github.ghzj.guli.common.exception.GlobalException;
import io.github.ghzj.guli.common.exception.ServiceException;
import io.github.ghzj.guli.common.exception.enums.GlobalErrorCodeConstants;
import io.github.ghzj.guli.common.utils.ExceptionUtil;
...
public class DubboProviderExceptionFilter implements Filter, Filter.Listener {
    ...
    private GlobalException constraintViolationExceptionHandler(ConstraintViolationException ex) {
        ...
        return new GlobalException(GlobalErrorCodeConstants.BAD_REQUEST.getCode(),
    ...
    private GlobalException defaultExceptionHandler(Throwable exception, Invocation invocation) {
        ...
        return new GlobalException(GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR)
