    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="addOrUpdateHandle(scope.row.${pk.humpAttrName})">修改</el-button>
          <el-button type="text" size="small" @click="deleteHandle(scope.row.${pk.humpAttrName})">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
